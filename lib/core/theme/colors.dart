...
class AppColors {
  ...
  // ========== Category Colors ==========
  static const Color catShopping = Color(0xFF9C27B0); // Purple
  static const Color catFood = Color(0xFFFF9800); // Orange
  static const Color catTransport = Color(0xFF2196F3); // Blue
  static const Color catBills = Color(0xFFF44336); // Red
  static const Color catEntertainment = Color(0xFFE91E63); // Pink
  static const Color catTransfer = Color(0xFF3F51B5); // Indigo
  static const Color catAtm = Color(0xFF009688); // Teal
  static const Color catSalary = Color(0xFF4CAF50); // Green
  static const Color catOther = Color(0xFF9E9E9E); // Grey
